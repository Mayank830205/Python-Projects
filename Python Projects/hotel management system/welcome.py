...
files1=Image.open("C:\\Users\\HP\\Desktop\\hotel management system\\wel.png")  # used for open image
...
A=Label(win,text="   HOTEL MANAGEMENT   ",bg="white",fg="black",font=("Lucida Calligraphy",40,"bold","underline"))
A.place(x=190,y=80)
