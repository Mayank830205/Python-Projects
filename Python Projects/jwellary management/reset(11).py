...
files1=Image.open("C:\\Users\\HP\\Desktop\\JWELLARY MANAGEMENT\\image\\welcome.png")  # used for open image
files2=files1.resize((400,640)) #for assign size
...
C=Label(win,text="USERNAME",bg="snow2",fg="black",font=("Lucida Calligraphy",15,"bold"))
C.place(x=450,y=180)
